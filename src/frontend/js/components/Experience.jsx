...
const position = acf.experience;
const Experience = ({searchExperience, setSearchExperience}) => {
    const [selected, setSelected] = useState(position[0])
    const [query, setQuery] = useState('')

    useEffect(() => {
      setSearchExperience(selected)
    }, [selected]);
    ...
    return (
        <div className="relative max-w-sm z-10 mx-2">
